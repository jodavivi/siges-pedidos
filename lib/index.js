...
//importal modelo
require('./modelBd/entity/Pedido');
require('./modelBd/entity/PedidoDetalle'); 
require('./modelBd/entity/PedidoEstado'); 
...
const app = express();
  ...
  log4js.configure({
    appenders: {
      siges_pedidos: {
        type: "dateFile",
        filename: "./log/siges-pedidos.log",
        pattern: "yyyy-MM-dd",
        compress: true,
      },
    },
    categories: {
      default: { appenders: ["siges_pedidos"], level: "debug" },
    },
  });
...
const logger = log4js.getLogger("siges_pedidos"); 
