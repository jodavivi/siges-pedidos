...
exports.crearPedido = async function (oParam) { 
    ...
    try { 
        ...
        oRegistro.CodSede            = oParam.oAuditRequest.oUsuarioCaja.CodSede;
        oRegistro.Sede              = oParam.oAuditRequest.oUsuarioCaja.Sede;
        oRegistro.CodApertura       = oParam.oAuditRequest.oUsuarioCaja.CodApertura;
        oRegistro.Codigo            = utilsGen.generarCodigo(seq.oData,9,"P"); 
